...
const urls = [
...

  {
    ...
    story:
      "The chart visually presents attendance data for Rajya Sabha sessions over a certain timeframe. It likely illustrates the presence and absence of members during these sessions, potentially highlighting trends, patterns, or variations in their participation.",
    color:
      "It seems like you're describing a visual representation where different colors represent different aspects related to legislative sessions and the presence of Members of the Legislative Assembly (MLAs). Blue represents total seats, green represents the MLAs present, and orange represents the total number of MLAs present in a session. If you have a specific question or need further assistance with this concept, please feel free to ask!",
  },

  {
    ...
    story:
      "The chart provides a concise overview of population-related metrics for different states. It likely displays the population count, the rate at which the population has grown over ten-year periods, and the population density (people per unit area) for each state. This allows for a quick understanding of how populations have changed, expanded, or concentrated across various regions.",
    color:
      "Blue: Represents the percentage increase in the total population of the state over a certain period of time. The shade of blue could vary depending on the magnitude of the increase, with darker shades indicating higher growth rates.",
  },
...

  {
    ...
    story:
      "The chart offers a snapshot of healthcare resources in different cities. It likely lists the number of doctors and wellness centers available in each city, providing a quick comparison of medical services. This information helps assess the healthcare infrastructure and accessibility for residents across various urban areas.",
    color:
      "In the informative graphic, the varying shades of blue across different districts depict the number of doctors available, with darker hues indicating higher counts, while distinct icons within the blue area denote the presence of different types of doctors, such as homeopathy and allopathy practitioners.",
  },
  {
    type: "sugar",
    title:
...

  {
    ...
    story:
      "The chart compiles a list of essential life-saving drugs. It likely showcases medications that are crucial for treating critical medical conditions and saving lives. This visual representation provides insight into the availability, accessibility, and importance of these drugs in healthcare systems, highlighting their role in addressing various health emergencies and improving patient outcomes.",
    color:
      "This chart employs the color blue to visually depict the significant impact of drug consumption on saving lives. The varying shades of blue within the chart represent the number of lives that have been positively affected by individuals who have consumed specific drugs.",
  },
  {
    ...
    story:
      "The chart illustrates the regional distribution of facilities provided under the " +
      "Atmanirbhar Bharat" +
      " initiative. Each state is represented, showcasing the number of facilities it has received. This visual representation helps to comprehend how the initiative's benefits have been extended across different parts of the country, fostering self-reliance and development on a state-wise basis.",
  },
  {
    type: "petrolium",
    layout: {
    ...
    story:
      "The chart presents a concise depiction of the price fluctuations for petroleum gas, kerosene, and diesel over a specific period. This visual representation offers insight into the changing costs of these essential fuels, enabling viewers to quickly grasp the trends and patterns in their pricing dynamics.",
  },
];
function Chart() {
...
// </a>
      ...
      <div className="">
        <Plotlyy data={plotData} layout={currentItem.layout} />
      </div>
      <div className="bg-white">
        {currentItem.story && (
          <div className="bg-slate-red-300 h-6 w-22">
            
            <h1 className="subpixel-antialiased">{currentItem.color}</h1>
            <h1 className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
              {currentItem.story}
            </h1>
          </div>
        )}
